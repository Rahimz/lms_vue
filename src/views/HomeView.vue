  ...
  <div class="home">
    <div class="hero is-info is-medium">
      <div class="hero-body has-text-centered">
        ...
        <h2 class="subtitle">An online place to learn what you want</h2>
      </div>
    ...
    <div class="section">
      <div class="container">
        <div class="columns is-multiline">
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              <span class="icon is-size-2 has-text-info"><i class="far fa-comment"></i></span>
          ...
          <div class="column is-12 has-text-centered">
            <a class="button is-info is-size-3 mt-6 mb-6" href="/sign-up">Click to get started</a>
          </div>
